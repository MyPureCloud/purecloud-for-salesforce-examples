...
* Genesys updates and releases the Genesys Cloud for Salesforce managed package with LMS support.
...
5. Under **Client Events Messages** section, configure **Client Event Messages**.
6. For **Client Event Message Type**, select **Lightning Message Service**.
